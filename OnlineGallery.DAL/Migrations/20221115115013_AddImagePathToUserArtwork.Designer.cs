...
namespace OnlineGallery.Data.Migrations
{
    ...
    [Migration("20221115115013_AddImagePathToUserArtwork")]
    partial class AddImagePathToUserArtwork
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineGallery.Model.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OnlineGallery.Model.Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineGallery.Model.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineGallery.Model.Folder", b =>
                {
                    b.HasOne("OnlineGallery.Model.AppUser", "CreatedByUser")
                        .WithMany()
